...
\mbox{v odstavcích} nepoužívá. Hladká sazba je určena především      %\mbox pro 'v' na dalsim radku
...
\begin{quotation}
Čím více \textit{druhů}, \textbf{řezů}, {\tiny velikostí}, {\color{red} barev} písma a jiných {\footnotesize EFEKTŮ} použijeme, tím \verb|profesionálněji| bude {\Large \fontfamily{pzc}\selectfont dokument} vypadat.
...
Pro systematické doplnění vlnek slouží volně šiřitelný program \emph{vlna} od pana Olšáka\footnote{Viz \href{http://petr.olsak.net/ftp/olsak/vlna/}{{\fontfamily{cmtt}\selectfont http://petr.olsak.net/ftp/olsak/vlna/}}}.
